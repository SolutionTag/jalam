...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <link href="${path}/bootstrap/dist/css/bootstrap.css" rel="stylesheet">
    <!-- MetisMenu CSS -->
    ...
    <script type="text/javascript" src="${path}/dist/js/amq_jquery_adapter.js"></script>
    <script type="text/javascript" src="${path}/dist/js/amq.js"></script>
     <script type="text/javascript" src="${path}/dist/js/prototype.js"></script>
      <script type="text/javascript" src="${path}/dist/js/behaviour.js"></script>
    
    <script>
     var  distributorid='<%=request.getSession().getAttribute("distributorid")%>';
     
   </script>
	<%-- <script type="text/javascript" src="${path}/dist/js/_prototype.js"></script>
	<script type="text/javascript" src="${path}/dist/js/behaviour.js"></script>
...
<body>
 <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0" id="headerunion">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="${path}/log-out"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">${wCanStockInfo.canName}</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
    ...
    <script>
 //   var myQ =org.activemq.AmqAdapter;
    //amq.uri="http://localhost:8080/canwater/amq"
    	function init() {
        var myQ =org.activemq.Amq;
        myQ.init({
            uri: '/canwater/amq',
            logging: true,
            timeout: 20,
        ...
        myQ.addListener('theBrowser', 'topic.events', function(msg) {
        	//$("#headerunion").css("background","red");
        	alert(msg.textContent)
        	 $('#messages').append('<li>' + msg.textContent + '</li>')
        },{selector:"ID=\'"+distributorid+"\'"});
     
           
        $('#sendMessage').submit(function() {
            var msg = $('#msg').val();
            myQ.sendMessage('queue.process', msg);
    ...
    $(document).ready(init);
    	...
    	/* function init() {
    	    var amq = org.activemq.AmqAdapter;
    	    amq.init({
    	        uri: 'amq',
    	        logging: true,
    	        timeout: 20
